...
class _wishlistState extends State<wishlist> {
  ...
  Widget build(BuildContext context) {
    final cartprovider=Provider.of<data>(context);
    return Scaffold(
    ...
    child: Consumer<data>(builder: (context, value, child) {
      return ListView.builder(itemBuilder: (context, index) {
        return value.wishlist.contains(index)?AnimatedOpacity(
    ...
    Padding(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          cartprovider.set_visibiility(0.0);

          Timer(
            Duration(milliseconds: 300),
                () {
                  cartprovider.reset_wish();
              cartprovider.set_visibiility(1);
